...
namespace Tagent.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult ViewProfile(int id)
        {
            ...
            var advisor = _userSerivce.Get(a => a.AccountId == id, null);
            if (user != null && advisor != null)
            {
                var resource = _mapper.Map<UserProfileResponse>(user);
        ...
        #region Edit Profile
        [HttpPut("profile")]
        public IActionResult EditProfile([FromBody] UserProfileRequest advisorRequest)
        {
